...
function FacebookLogin () {
  ...
  console.log(posted);
const userdef = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS2mejIovdVKePsxohV7u6FmLj6i4CqaVLT1A&s"
  useEffect(() => {
  ...
  return (
   <div>
    ...
    <img  src='https://www.cdnlogo.com/logos/f/23/facebook.svg' style={{ width: '180px', height: '56px' , position: 'relative', left:"-50%" }} />
                ...
                <div class="stories__content">
                  ...
                  <button class="story story--has-story">
                    <div class="story__avatar">
                      ...
                      <br/><span class="story__user">Aqsa</span><br/>
                    </div>
                  ...
                  <button class="story story--has-story">
                    <div class="story__avatar">
                      ...
                      <br/><span class="story__user">Hoorma</span><br/>
                    </div>
                  ...
                  <button class="story">
                    <div class="story__avatar">
                      ...
                      <br/><span class="story__user">Javi</span><br/>
                    </div>
                  ...
                  <button class="story">
                    <div class="story__avatar">
                      ...
                      <br/>
                      <span class="story__user">Ayesha</span><br/>
                    </div>
                  ...
                  <button class="story">
                    <div class="story__avatar">
                      ...
                      <br/>
                      <span class="story__user">Muneeba</span>
                      <br/>
                    </div>
                    <br/>
                  </button>
      ...
      <article class="post">
        <div class="post__header">
          <div class="post__profile">
            <a
              href="https://github.com/Arfa Shoukat"
              target="_blank"
              class="post__avatar"
            >
              <img src={userdef} alt="User Picture" />
        ...
        <div class="post__footer">
          ...
          <div class="post__infos">
            <div class="post__likes">
              ...
              <span
                >Liked by
                <a class="post__name--underline" href="#">Aqsa</a> and
            ...
            <section class="side-menu">
              <div class="side-menu__user-profile">
                ...
                <div class="side-menu__user-info">
                  <a href="https://github.com/Arfa Shoukat" target="_blank"
                    >Friends</a
                  >
                  <br/>
                </div>
